#' This is a function used to solve the knapsack problem with a recursive algorithm
#'
#' This function solves the knapsack problem using a recursive algorithm.
...
#' recursive_alg_knapsack(knapsack_objects[1:8,],2000)
#' 
#' 
...
# test with recursive_alg_knapsack(knapsack_objects[1:12,],3500)
recursive_alg_knapsack = function(x,W){
  if(W < 0){
